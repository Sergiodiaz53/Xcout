...
urlpatterns = [
    ...
    url(r'^annotation_between/', functions.generateJSONAnnotationFromSpecieBetweenPositions,
        name='generateJSONAnnotationFromSpecieBetweenPositions'),
    url(r'^load_annotations/', functions.loadAnnotations, name='loadAnnotations'),
    url(r'^annotation_between_paginated/', functions.generateJSONAnnotationFromSpecieBetweenPositionsPaginated,
        name='generateJSONAnnotationFromSpecieBetweenPositionsPaginated'),
    ...
    url(r'^annotation_blast_csv/', functions.generateAnnotationsBlastResultsCSV,
        name='generateAnnotationsBlastResultsCSV'),
